...
function_by_tile = {(0, 1): lambda s: (0.375 + 0.625 * s, 1 - 0.625 * s),
                    (1, 0): lambda s: (1 - 0.375 * s, 0.625 + 0.375 * s),
                    (0, 2): lambda s: (0.375, s),
                    (2, 0): lambda s: (0.625, 1 - s),
                    (0, 3): lambda s: (0.375 - 0.375 * s, 1 - 0.375 * s),
                    (3, 0): lambda s: (0.625 * s, 0.375 + 0.625 * s),
                    (1, 2): lambda s: (1 - 0.625 * s, 0.625 - s * 0.625),
                    (2, 1): lambda s: (0.625 + s * 0.375, 0.375),
                    (1, 3): lambda s: (1 - s, 0.625),
                    (3, 1): lambda s: (s, 0.375),
                    (2, 3): lambda s: (0.625 - s * 0.625, 0.625 * s),
                    (3, 2): lambda s: (s * 0.375, 0.375 - 0.375 * s)}
